-- Variable
local amount = 80 -- Amount of zooming (/!\ Integer, must be greater than smoothness)
local zoomTime = 0.1 -- Total time of zoom in seconds (Theoretical, mesure and set approxZoomTime so it will be more accruate)
...
reaper.Undo_EndBlock("Smooth vertical scroll", 1)
